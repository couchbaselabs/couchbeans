...
public class MutationTreeWalker {
     ...
     * @param path the path of the current bean relative to the start bean
     * @param pathProvider takes current (or start) bean and returns all paths to be traversed from it
     * @param invertPath used for reverse traversal of the graph
     * @return an array of traversed paths
     */
    ...
    /**
     * Applies Method.Arguments to the corresponding method
     * @param target
     * @param arguments
     */
